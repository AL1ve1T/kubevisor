 ...
 * {@code kubetopo.k8s-api-url} (default {@code http://localhost:8001},
...
public class PodStatusScraper {
    ...
    @Scheduled(fixedDelayString = "${kubetopo.pod-status-scrape-interval-seconds:5}000")
    public void scrape() {
     ...
     * by {@link com.kubetopo.ingestion.ResourceMetricsProcessor}.
     */
