...
public class KubernetesPodWatcher {
    ...
    public KubernetesPodWatcher(PodIpResolver podIpResolver,
            ...
            @Value("${kubetopo.pod-watcher.namespace:default}") String targetNamespace) {
    ...
    @Scheduled(fixedDelayString = "${kubetopo.pod-watcher.interval-ms:15000}", initialDelay = 5000)
