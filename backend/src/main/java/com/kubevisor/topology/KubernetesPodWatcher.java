...
public class KubernetesPodWatcher {
    ...
    public KubernetesPodWatcher(PodIpResolver podIpResolver,
            ...
            @Value("${kubevisor.pod-watcher.namespace:default}") String targetNamespace) {
    ...
    @Scheduled(fixedDelayString = "${kubevisor.pod-watcher.interval-ms:15000}", initialDelay = 5000)
