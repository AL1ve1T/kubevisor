# kubetopo.backend Documentation

`kubetopo.backend` is a Kubernetes observability backend. It ingests OpenTelemetry
...
| [configuration.md](configuration.md) | `kubetopo.*` properties, Spring profiles, environment variables |
